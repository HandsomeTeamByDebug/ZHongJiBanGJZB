...
<body>
	...
	<div class="mainbox">
		...
		<div class="mainleft">
			<div class="leftinfo" style="width:700px;">
				<div class="listtitle">
			...
			<div class="leftinfos">
				...
				<div class="infoleft" style="height:280px">

					<div class="listtitle" >
						<a href="javascript:morePorjects()" class="more1">更多</a>最新项目发布
					</div>
					<ul class="newlist" style="height:250px, width:200px" id="newProject"></ul>
		...
		<div class="mainright">
			...
			<div class="dflist" style="width:500px;">
				<div class="listtitle">
					<a href="#" class="more1">更多</a>热门项目
				</div>
				<ul class="newlist" style="height:250px, width:200px" id="hotProject">
				</ul>
			</div>


			<div class="dflist1" style="width:500px;">
				<div class="listtitle">
					<a href="#" class="more1">更多</a>大神级别的人物
				</div>
				<!-- <ul class="newlist" style="height:250px, width:200px" id="pro_user">
					<li><i style="width:100px">用户名：</i><i style="width:100px">中标次数</i><i style="width:100px">金钱</i></li>
				</ul> -->
